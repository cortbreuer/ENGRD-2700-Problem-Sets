...
$s^2_{n-1} = 30000^2 = 900000000$

$s^2_{n-1} = \frac{1}{n-2} \sum\limits^{n-1}_{i=1}$
...
$= \frac{1}{n}\sum\limits_{i=1}^{n} \Big[ \frac{x_{i}}{s_{x}} - \frac{\overline{x}}{s_{x}} \Big]$

$= \frac{\overline{x}}{s_{x}} - \frac{\bar{x}}{s_{x}}$

$\bar{z} = 0$

$s^2_{z} = \frac{1}{n-1} \sum\limits^{n}_{i=1} (z_{i} - \bar{z})^2 = \frac{1}{n-1} \sum\limits^{n}_{i=1} \frac^{x_{i} - \bar{x}}_{s_{x}}$
